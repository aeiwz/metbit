...
class pca:
    ...
    def plot_pca_trajectory(self, time_, time_order, stat_ = ['mean', 'sem'], pc=['PC1', 'PC2'],
        ...
        point_unique = df_scores_point['Group'].unique()


        for connect_line in range(len(group_unique)):
            Group = point_unique[connect_line]
            ...
            fig.add_trace(go.Scatter(
                ...
                line=dict(color=color_dict_2[Group], width=2), # set the color_ and width of the line
