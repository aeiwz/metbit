...
data = pd.read_csv('/tank/theerayut/Project/Thesis/Analyse/Dataset/FW_noesy_pqn.csv')
...
path_ = "/tank/theerayut/Project/Thesis/Analyse/Report/OPLSDA_FW"
...
data = pd.read_csv('/tank/theerayut/Project/Thesis/Analyse/Dataset/U_noesy_pqn.csv')
...
path_ = "/tank/theerayut/Project/Thesis/Analyse/Report/OPLSDA_U"
os.makedirs(path_, exist_ok=True)
...
data = pd.read_csv('/tank/theerayut/Project/Thesis/Analyse/Dataset/P_cpmg_no_pqn.csv')
...
path_ = "/tank/theerayut/Project/Thesis/Analyse/Report/OPLSDA_P"
os.makedirs(path_, exist_ok=True)
